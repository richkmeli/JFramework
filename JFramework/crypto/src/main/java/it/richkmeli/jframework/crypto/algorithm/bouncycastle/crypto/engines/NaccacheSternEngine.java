...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.AsymmetricBlockCipher;
...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.params.NaccacheSternKeyParameters;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.params.NaccacheSternPrivateKeyParameters;
...
public class NaccacheSternEngine
     ...
     *
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.AsymmetricBlockCipher#init(boolean,
     * it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.CipherParameters)
     */
     ...
     *
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.AsymmetricBlockCipher#getInputBlockSize()
     */
     ...
     *
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.AsymmetricBlockCipher#getOutputBlockSize()
     */
     ...
     *
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.AsymmetricBlockCipher#processBlock(byte[],
     * int, int)
     */
