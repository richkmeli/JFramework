 ...
 *
 * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.params.AEADParameters
 */
public interface AEADCipher {
     ...
     * @throws it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.InvalidCipherTextException if the MAC fails to match.
     */
