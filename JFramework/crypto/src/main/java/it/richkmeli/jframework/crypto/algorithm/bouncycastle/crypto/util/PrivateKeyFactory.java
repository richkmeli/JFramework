...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.cryptopro.CryptoProObjectIdentifiers;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.cryptopro.ECGOST3410NamedCurves;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.cryptopro.GOST3410PublicKeyAlgParameters;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.edec.EdECObjectIdentifiers;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.oiw.ElGamalParameter;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.oiw.OIWObjectIdentifiers;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.pkcs.DHParameter;
...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.rosstandart.RosstandartObjectIdentifiers;
...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x509.DSAParameter;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x509.X509ObjectIdentifiers;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x9.ECNamedCurveTable;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x9.X962Parameters;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x9.X9ECParameters;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x9.X9ObjectIdentifiers;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.ec.CustomNamedCurves;
...
//      else if (algOID.equals(X9ObjectIdentifiers.dhpublicnumber))
            ...
            if (p instanceof ASN1Sequence && (ASN1Sequence.getInstance(p).size() == 2 || ASN1Sequence.getInstance(p).size() == 3)) {
                ...
                if (privKey instanceof ASN1Integer) {
                    ...
                    it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.sec.ECPrivateKey ec = it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.sec.ECPrivateKey.getInstance(privKey);
