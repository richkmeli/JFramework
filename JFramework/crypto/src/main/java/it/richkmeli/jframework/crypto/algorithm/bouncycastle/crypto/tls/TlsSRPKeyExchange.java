...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.agreement.srp.SRP6Client;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.agreement.srp.SRP6Server;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.agreement.srp.SRP6Util;
...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.util.io.TeeInputStream;
...
public class TlsSRPKeyExchange extends AbstractTlsKeyExchange {
    ...
    public void processServerCertificate(Certificate serverCertificate) throws IOException {
        ...
        it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x509.Certificate x509Cert = serverCertificate.getCertificateAt(0);
