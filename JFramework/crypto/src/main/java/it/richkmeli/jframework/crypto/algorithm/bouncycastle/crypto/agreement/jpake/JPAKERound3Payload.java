package it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.agreement.jpake;
...
public class JPAKERound3Payload {
     ...
     *
     * @see JPAKEUtil#calculateMacTag(String, String, BigInteger, BigInteger, BigInteger, BigInteger, BigInteger, it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.Digest)
     */
