...
public abstract class ASN1External
    ...
    /* (non-Javadoc)
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.ASN1Primitive#asn1Equals(it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.ASN1Primitive)
     */
