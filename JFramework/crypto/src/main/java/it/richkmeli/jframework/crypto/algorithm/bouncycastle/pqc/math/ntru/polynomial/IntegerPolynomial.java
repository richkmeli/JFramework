package it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.math.ntru.polynomial;

import it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.math.ntru.euclid.BigIntEuclidean;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.math.ntru.util.ArrayEncoder;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.math.ntru.util.Util;
...
public class IntegerPolynomial
     ...
     * This array contains enough prime numbers so primes never have to be computed on-line for any standard {@link it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.crypto.ntru.NTRUSigningParameters}.
     */
