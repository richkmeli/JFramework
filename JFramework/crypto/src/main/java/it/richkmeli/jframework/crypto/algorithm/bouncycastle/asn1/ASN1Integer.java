...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.util.Properties;
...
public class ASN1Integer
     ...
     * </p>
     * <p>
     * Users can set the 'it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.allow_unsafe_integer' to 'true'
        ...
        switch (bytes.length) {
            ...
            default:
                return bytes[0] == (bytes[1] >> 7)
                        ...
                        && !Properties.isOverrideSet("it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.allow_unsafe_integer");
        }
    }
