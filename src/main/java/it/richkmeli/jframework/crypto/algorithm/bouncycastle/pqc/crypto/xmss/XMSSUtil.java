...
public class XMSSUtil {
    ...
    private static class CheckingStream
        ...
        static {
            ...
            components.add("it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.crypto.xmss.BDS");
            components.add("java.util.ArrayList");
            components.add("it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.crypto.xmss.XMSSNode");
            components.add("[B");
            ...
            components.add("it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.crypto.xmss.BDSTreeHash");
        }
