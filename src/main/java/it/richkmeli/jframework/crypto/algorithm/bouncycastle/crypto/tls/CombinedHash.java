...
class CombinedHash
    ...
    /**
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.Digest#getAlgorithmName()
     */
    ...
    /**
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.Digest#getDigestSize()
     */
    ...
    /**
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.Digest#update(byte)
     */
    ...
    /**
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.Digest#update(byte[], int, int)
     */
    ...
    /**
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.Digest#doFinal(byte[], int)
     */
    ...
    /**
     * @see it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.Digest#reset()
     */
    public void reset() {
        md5.reset();
        sha1.reset();
