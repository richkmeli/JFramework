...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.modes.KGCMBlockCipher;
...
public class KGMac
     ...
     *
     * @param macSizeBits the mac size to generate, in bits. Must be a multiple of 8 and &gt;= 32 and &lt;= 128.
