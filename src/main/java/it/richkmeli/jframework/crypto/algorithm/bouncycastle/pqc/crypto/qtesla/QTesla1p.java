package it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.crypto.qtesla;
...
class QTesla1p {
    ...
    static void sample_y(long[] y, byte[] seed, int seedOffset, int nonce) { // Sample polynomial y, such that each coefficient is in the range [-B,B]
    ...
    private static void at(byte[] bs, int base, int index, int value) {
        it.richkmeli.jframework.crypto.algorithm.bouncycastle.util.Pack.intToLittleEndian(value, bs, (base * 4) + (index * 4));
    }
    ...
    static boolean test_correctness(long[] v, int vpos) { // Check bounds for w = v - ec during signature verification. Returns 0 if valid, otherwise outputs 1 if invalid (rejected).
    ...
    static class QTesla1PPolynomial {
        ...
        static void poly_pointwise(long[] result, long[] x, long[] y) { // Pointwise polynomial multiplication result = x.y
        ...
        static void poly_pointwise(long[] result, int rpos, long[] x, int xpos, long[] y) { // Pointwise polynomial multiplication result = x.y
        ...
        static void poly_mul(long[] result, long[] x, long[] y) { // Polynomial multiplication result = x*y, with in place reduction for (X^N+1)
        ...
        static void poly_mul(long[] result, int rpos, long[] x, int xpos, long[] y) { // Polynomial multiplication result = x*y, with in place reduction for (X^N+1)
        ...
        static void poly_sub(long[] result, int rpos, long[] x, int xpos, long[] y, int ypos) { // Polynomial subtraction result = x-y
        ...
        static void poly_add_correct(long[] result, int rpos, long[] x, int xpos, long[] y, int ypos) { // Polynomial addition result = x+y with correction
        ...
        static void poly_sub_correct(int[] result, int[] x, int[] y) { // Polynomial subtraction result = x-y with correction
