...
public class NISTCTSBlockCipher
     ...
     * @throws it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.DataLengthException if there isn't enough space in out.
     ...
     * @return the number of output bytes copied to out.
     * @throws it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.DataLengthException        if there is insufficient space in out for
     *                                                                                                 the output.
     * @throws IllegalStateException                                                                   if the underlying cipher is not
     *                                                                                                 initialised.
     * @throws it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.InvalidCipherTextException if cipher text decrypts wrongly (in
