...
public class SCVPReqRes
     ...
     * <li> {@link it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.ASN1Sequence#getInstance(Object) ASN1Sequence} input formats with SCVPReqRes structure inside
     * </ul>
     *
