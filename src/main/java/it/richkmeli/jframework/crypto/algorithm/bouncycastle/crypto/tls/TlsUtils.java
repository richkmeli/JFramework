...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x509.Extensions;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x509.KeyUsage;
...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.macs.HMac;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.params.*;
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.util.PublicKeyFactory;
...
import it.richkmeli.jframework.crypto.algorithm.bouncycastle.util.Shorts;
...
public class TlsUtils {
    ...
    static void validateKeyUsage(it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x509.Certificate c, int keyUsageBits)
            throws IOException {
    ...
    static short getClientCertificateType(Certificate clientCertificate, Certificate serverCertificate)
        ...
        it.richkmeli.jframework.crypto.algorithm.bouncycastle.asn1.x509.Certificate x509Cert = clientCertificate.getCertificateAt(0);
