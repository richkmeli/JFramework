package it.richkmeli.jframework.crypto.algorithm.bouncycastle.crypto.encodings;
...
public class PKCS1Encoding
     ...
     */
    public static final String STRICT_LENGTH_ENABLED_PROPERTY = "it.richkmeli.jframework.crypto.algorithm.bouncycastle.pkcs1.strict";

    /**
     * some providers fail to include the leading zero in PKCS1 encoded blocks. If you need to
     * work with one of these set the system property it.richkmeli.jframework.crypto.algorithm.bouncycastle.pkcs1.not_strict to true.
     * <p>
     * The system property is checked during construction of the encoding object, it is set to
     * false by default.
     * </p>
     */
    public static final String NOT_STRICT_LENGTH_ENABLED_PROPERTY = "it.richkmeli.jframework.crypto.algorithm.bouncycastle.pkcs1.not_strict";
