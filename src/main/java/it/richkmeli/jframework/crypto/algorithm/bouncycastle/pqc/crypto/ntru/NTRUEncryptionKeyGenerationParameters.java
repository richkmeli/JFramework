...
public class NTRUEncryptionKeyGenerationParameters
     ...
     * @param c            a parameter for the Index Generation Function ({@link it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.crypto.ntru.IndexGenerator})
     ...
     * @param sparse       whether to treat ternary polynomials as sparsely populated ({@link it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.math.ntru.polynomial.SparseTernaryPolynomial} vs {@link it.richkmeli.jframework.crypto.algorithm.bouncycastle.pqc.math.ntru.polynomial.DenseTernaryPolynomial})
